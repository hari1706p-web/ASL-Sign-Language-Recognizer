# ASL Sign Language Recognizer — All Project Files

Single combined file containing every uploaded project file, each labeled with its filename.
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Real-time American Sign Language (ASL) alphabet recognition using your webcam, TensorFlow.js hand pose detection, and a KNN classifier." />
    <title>ASL Sign Language Recognizer</title>
  </head>
...
```json
{
  ...
  "version": "1.0.0",
  "type": "module",
  "description": "Real-time ASL alphabet recognition using webcam hand landmarks and a KNN classifier",
  "scripts": {
    "dev": "vite",
    "build": "vite build",
